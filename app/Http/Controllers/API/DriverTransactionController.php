...
use App\Http\Requests\DriverTransaction\CreateBankAccountRequest;
use App\Http\Requests\DriverTransaction\HistoryRequest;
use App\Http\Requests\DriverTransaction\ListBankAccountRequest;
use App\Http\Requests\DriverTransaction\PayRequest;
use App\Http\Requests\DriverTransaction\SaldoRequest;
use App\Http\Requests\DriverTransaction\TopUpRequest;
use App\Http\Requests\DriverTransaction\WithdrawRequest;
...
class DriverTransactionController extends Controller
{
    ...
    public function top_up(TopUpRequest $request): JsonResponse
    {
        ...
        try {
            ...
            $saldo = Transaction::saldoDriver($identity_owner);
